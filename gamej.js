...
var w, h, k, xo, yo,
    ...
    enemies = [],
    explosions = [],
    dif = [' Novato', ' Facil', ' Dificil', ' Profesional', ' Maestro', ' Leyenda', ' Divina', ' SemiDios', ' ProDios', 'DIOS'],
    gameTime = 0,
    isGameOver,
    enemydep = 1,
    firstwave = false,
    ...
    lvl = 0,
    inf = function(){
    alert(" Creador : Ronald Ramos Malca \n\n Creado : 1/08/2018 \n\n Publicado :  8/8/18 \n\n Ultima Actualización : 02/05/2019\n\nAll rights reserved by Play DoolPool." )
    };
   ...
   Unit.prototype = {
    ...
    switch (a) {
       ...
       case 'win' :
           ...
           alert ("mision completada! Tu tiempo es " + _min + ':' + _sec + '\n\nPérdida '+ counter +' tanques.\n\nTanques destruidos: ' + counter2 + '.');
           
           var log_item = "<p>Juego  " + ++gameNum + ": 🏆 Tiempo ⏲" + _min + ':' + _sec + ' /' + dif[lvl] + ' /' + "</p>";
...
///^^^^^^^///////////^^^^/////////
  ...
  function loader() {
     ...
     maindiv.innerHTML = '<button id="start" onclick="startGame ()">Iniciar Juego</button><button id="info" onclick="inf()">Información</button><br/><br/><span id="dif">Dificultad:' + dif[lvl] + '</span>';
